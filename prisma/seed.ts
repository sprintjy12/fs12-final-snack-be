...
async function main() {
  ...
  const orderSpecs: Array<{
    ...
    // 구매 요청 리스트 테스트용 PENDING 추가
    {
      ...
      type: OrderType.REQUEST,
      status: OrderStatus.PENDING,
      requestMessage: "회의 다과 준비 부탁드립니다.",
      responseMessage: null,
      approvedAt: null,
      createdAt: daysAgo(0),
      items: [
    ...
    },
    {
      ...
      type: OrderType.REQUEST,
      status: OrderStatus.PENDING,
      requestMessage: "탕비실 음료가 다 떨어졌어요.",
      responseMessage: null,
      approvedAt: null,
      createdAt: daysAgo(2),
      items: [
        {
          productId: productsA[3].product.id,
          unitPrice: productsA[3].product.price,
          quantity: 6,
          productName: productsA[3].product.name,
          imageUrl: productsA[3].product.imageUrl,
          categoryName: productsA[3].categoryName,
        },
        {
    ...
    },
    {
      ...
      type: OrderType.REQUEST,
      status: OrderStatus.PENDING,
      requestMessage: "야근 간식 보충 요청드립니다.",
      responseMessage: null,
      approvedAt: null,
      createdAt: daysAgo(3),
      items: [
    ...
    },
    {
      ...
      type: OrderType.REQUEST,
      status: OrderStatus.PENDING,
      requestMessage: "신입 환영회용 스낵 부탁드려요.",
      responseMessage: null,
      approvedAt: null,
      createdAt: daysAgo(5),
      items: [
    ...
    },
    {
      ...
      type: OrderType.REQUEST,
      status: OrderStatus.PENDING,
      requestMessage: "커피머신용 원두/스낵 소량 요청",
      responseMessage: null,
      approvedAt: null,
      createdAt: daysAgo(7),
      items: [
  ...
  console.log("  orders         : 14 (PENDING 요청 7건 @스낵팩토리)");
  console.log("  order_items    : ~30");
